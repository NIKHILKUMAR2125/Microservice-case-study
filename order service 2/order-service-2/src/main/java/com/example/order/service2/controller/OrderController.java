package com.example.order.service2.controller;
...
import com.example.order.service2.service.OrderService;
...
public class OrderController {
    ...
    @GetMapping("/{id}")
    public ResponseTemplate getOrderWithProductCustomer(@PathVariable("id") Long product_id, Long customer_id) {
        return orderService.getOrderWithProductCustomer(product_id);
